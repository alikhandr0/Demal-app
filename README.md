...
<p align="center">
  <i>Темный полупрозрачный интерфейс на 100% написан на SwiftUI. Он обеспечивает обновление данных AQI в реальном времени от Open-Meteo и построение маршрутов в чистые зоны с помощью нативного MapKit.</i>
</p>
